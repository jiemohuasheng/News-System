package com.cbcnewsfeeds.android.cbcnewsfeeds.Adapter;
...
import com.cbcnewsfeeds.android.cbcnewsfeeds.R;

import java.util.List;

/**
 * Created by Ashok Sen Gurudayal on 17-03-2017.
 */
...
public class SlidingMenuAdapter  extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View v = View.inflate(context, R.layout.news_category, null);
